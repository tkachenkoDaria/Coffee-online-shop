...
class Search_Filter_Generate_Input
{
	...
	public function text( $args )
	{
		...
		<?php echo $prefix; ?><label>
			<?php if ( $accessibility_label != "" ) { ?><span class="screen-reader-text">
					<?php echo $accessibility_label; ?>
				</span><?php } ?><input<?php echo $attibutes_html; ?>>
		</label>
		<?php echo $postfix; ?>
		<?php
		...
		<?php echo $prefix; ?><label>
			...
			<select<?php echo $attibutes_html; ?>>
				...
				foreach ( $input_args['options'] as $option ) {
					...
					?>
					<option<?php echo $option_attibutes_html; ?> value="<?php echo esc_attr( $option->value ); ?>">
	...
	public function radio( $args )
	{
		...
		?>
			<ul class="ancor-wrapp" <?php echo $attibutes_html; ?>>
				...
				for ( $i = 0; $i < $option_count; $i++ ) {
					...
					echo '<li class="' . $option_class . '"' . $container_attibutes_html . '><input ' . $input_attibutes_html . '><label class="sf-label-radio ancor" for="' . $input_id . '">' . $option_label . '</label>';
					...
					if ( isset( $option->depth ) ) { //then we do depth calculations
						...
						if ( $close_ul ) {
							$diff = $current_depth - $next_depth;
							$open_child_count = $open_child_count - $diff;
							$str_repeat = str_repeat( "</ul></li></div>", $diff );
							echo $str_repeat;
	...
	public function range_slider( $args )
	{
		...
		?>
			<div <?php echo $attibutes_html; ?>>
				...
				<?php echo $value_min_html; ?><span class="sf-range-values-seperator">
					<?php echo $args['number_values_seperator']; ?>
				</span><?php echo $value_max_html; ?>
