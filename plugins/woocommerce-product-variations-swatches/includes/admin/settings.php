                    ...
                    <div class="vi-ui bottom attached tab segment vi-wpvs-tab-general" data-tab="general">
                        <table class="form-table">
                            ...
                            <tr>
                                <th>
                                    <label for="vi-wpvs-attribute_display_default">
										<?php esc_html_e( 'Prioritize first attribute', 'woocommerce-product-variations-swatches' ); ?>
                                    </label>
                                </th>
                                <td>
                                    <div class="vi-ui toggle checkbox">
                                        <input type="checkbox" name="prioritize_first_attribute"
                                               value="1" <?php checked( $this->settings->get_params( 'prioritize_first_attribute' ), '1' ) ?>><label></label>
                                    </div>
                                    <p class="description"><?php esc_html_e( 'For products that have more than 1 attribute, when selecting a value of the first attribute but the current combination is not available, select this value anyway and change selections of other attributes instead', 'woocommerce-product-variations-swatches' ); ?>                                    </p>
                                    <p class="description"><strong><?php esc_html_e( '*Important: ', 'woocommerce-product-variations-swatches' ); ?></strong><?php esc_html_e( 'To make out-of-stock items clickable, you have to turn off "Disable \'out of stock\' variation items" option', 'woocommerce-product-variations-swatches' ); ?>                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th>
