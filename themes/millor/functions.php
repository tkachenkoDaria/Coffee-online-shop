...
function millor_scripts() {
	...
	wp_enqueue_style( 'millor-swiperBundle', get_template_directory_uri() . "/assets/css/swiper-bundle.min.css" );
	...
	wp_enqueue_script( 'millor-mainJs', get_template_directory_uri() . '/assets/js/main.js', array(), _S_VERSION, true );
